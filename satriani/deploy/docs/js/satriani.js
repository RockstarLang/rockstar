...
function delist(expr, env) {
    env.FORCE_ARRAY_FLAG = true;
    let source = env.lookup(env.dealias(expr));
...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c300 = function(e, t) { return { enlist: { target: t, expression: e } }; },
      peg$c301 = "like",
      peg$c302 = peg$literalExpectation("like", true),
      peg$c303 = function(t, e) { return { enlist: { target: t, expression: e } }; },
      peg$c304 = "with",
      peg$c305 = peg$literalExpectation("with", true),
      peg$c306 = function(t) { return { enlist: { target: t } }; },
